...
const formatLinkPath = (text) => text.toLowerCase().replace(/ /g, "-");
...
function Footer() {
  return (
    <footer
      ...
      data-scroll-section
      className="z-20 w-full h-screen flex gap-5 relative
      font-['Founders_Grotesk_X-Condensed'] p-20 text-white bg-zinc-900 "
    >
      ...
      <div className="w-1/2">
        ...
        <div className="dets mt-10 font-['Neue_Montreal']">
          <h1 className="text-[2.2vh] mb-[2vh]">S:</h1>
          <div>
            {["Instagram", "Behance", "Facebook", "LinkedIn"].map(
              (item, index) => {
                return (
                  <a
                    key={item}
                    className="block underline font-light text-xl"
                    href="#"
                  >
                    {item}
                  </a>
        ...
        <div className="flex justify-between">
          <div className="dets mt-10 font-['Neue_Montreal']">
            <h1 className="text-[2.2vh] mb-[2vh]">L:</h1>
            <div>
              {[
                "202-1965 W 4th Ave",
                "Vancouver, Canada",
                ...
                return (
                  <a
                    key={item}
                    className={`block font-light text-xl underline ${
                      index === 1 ? "mb-10" : ""
                    }`}
                    href="#"
                  >
          ...
          <div className="mr-10 dets mt-10 font-['Neue_Montreal']">
            <h1 className="text-[2.2vh] mb-[3vh]">M:</h1>
            <div>
              {[
                "Home",
                "Services",
        ...
        <div className="mr-10 dets mt-10 font-['Neue_Montreal']">
          <h1 className="text-[2.2vh] mb-[3vh]">E:</h1>
          <div>
        ...
        <div className="flex justify-between">
          <h1 className="text-[2.2vh] mt-[9vh] text-[#B1B1B1] font-['Neue_Montreal']">
